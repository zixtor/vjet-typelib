...
fs.write(fd, null, null, null,   null) ; 
fs.write(fd, '',   null, null,   null) ;
fs.write(fd, '',   0,    null,   null) ;
fs.write(fd, '',   0,    'utf8', null) ;
...
var conz =constants.O_CREAT | constants.O_WRONLY | constants.O_TRUNC ;
