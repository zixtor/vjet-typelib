...
var fd2 ; //< Object
var fd3 ; // no decl so Object is inferred
...
for (var i = 0; i < N; i++) {
  ...
  fs.write(fd2, buffer, 0, buffer.length, null, function(er, written) {}) ;
  fs.write(fd3, buffer, 0, buffer.length, null, function(er, written) {}) ;
