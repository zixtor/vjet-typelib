 ...
 */
//> public
vjo.mtype('org.prototypejs.nativeext.FunctionExt')
...
.protos({
  ...
  **/
	//> public Function bind(Object context, Object... args)
	bind: vjo.NEEDS_IMPL,
   ...
   *      );
  **/
	//> public Function bindAsListener(Object context, Object... args)
	bindAsEventListener: vjo.NEEDS_IMPL,
  ...
  **/
	//> public Function curry(Object... args)
	curry: vjo.NEEDS_IMPL,
  ...
  **/
	//> public Number defer(Object... args)
	defer: vjo.NEEDS_IMPL,
  ...
  **/
	...
	//> public Number delay(Number timeout, Object... args)
	delay: vjo.NEEDS_IMPL,
   ...
   *      myElement.hide();
  **/
	//> public Function methodize()
	methodize: vjo.NEEDS_IMPL,
